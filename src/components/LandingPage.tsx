...
function LandingPage() {
  const bg =
    process.env.NODE_ENV === "development"
      ? `bg-[linear-gradient(to_bottom,rgba(0,0,0,1),rgba(0,0,0,0)),url("/assets/img/cargo3.jpg")]`
      : `bg-[linear-gradient(to_bottom,rgba(0,0,0,1),rgba(0,0,0,0)),url("https://drylrys08.github.io/erth-liner/assets/img/cargo3.jpg")]`;
  ...
  return (
    ...
    >
      <div className="h-full flex justify-center pb-36 flex-col gap-2 pl-2 lg:pl-10">
